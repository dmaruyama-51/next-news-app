...
export const getStaticProps = async () => {
  ...
  const topRes = await fetch(
    `https://newsapi.org/v2/top-headlines?country=jp&pageSize=${pageSize}&apiKey=16a42d8d040b48aa9c49ab30c7f08b80`
  );
  ...
  const weatherRes = await fetch(
    `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&units=metric&exclude=${exclude}&appid=4a610f91e9ab6019c974a441e1c05025`
  );
  ...
  const pickupRes = await fetch(
    `https://newsapi.org/v2/everything?q=${keyword}&language=jp&sortBy=${sortBy}&pageSize=${pickupPageSize}&apiKey=16a42d8d040b48aa9c49ab30c7f08b80`
  );
